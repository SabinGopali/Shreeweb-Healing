            ...
            <div className="space-y-4">
              ...
              <div className="pt-2">
                ...
                <div className="flex gap-3">
                  <a
                    className="w-10 h-10 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-blue-50 hover:scale-110 transition-all duration-300 shadow-sm border border-stone-200/50"
                    href="#"
                    target="_blank"
                    rel="noreferrer"
                    aria-label="Facebook"
                  ...
                  <a
                    className="w-10 h-10 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-pink-50 hover:scale-110 transition-all duration-300 shadow-sm border border-stone-200/50"
                    href="#"
                    target="_blank"
                    rel="noreferrer"
                  ...
                  <a
                    className="w-10 h-10 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-gray-50 hover:scale-110 transition-all duration-300 shadow-sm border border-stone-200/50"
                    href="#"
                    target="_blank"
                    rel="noreferrer"
                    aria-label="TikTok"
