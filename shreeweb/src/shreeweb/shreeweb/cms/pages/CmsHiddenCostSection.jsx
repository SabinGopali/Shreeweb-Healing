...
export default function CmsHiddenCostSection() {
  ...
  const resolveUrl = (url) => {
    ...
    // Frontend static assets like `/healing2.png` should not be prefixed.
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                <div className="w-full h-64 rounded-2xl overflow-hidden shadow-lg">
                  ...
                  />
                  <div className="w-full h-full bg-stone-200 rounded-2xl hidden items-center justify-center text-stone-500 text-sm">
                    Image not found
                  </div>
                </div>
              </div>
